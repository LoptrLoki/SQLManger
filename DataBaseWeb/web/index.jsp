...
<html>
  ...
  <div id="container"  style="line-height: 20px;background-color:  	 	GhostWhite;text-align: center; align-items: center; width: 40%;height: 89%;margin: 50px auto;margin-top: 100px;opacity: 0.95;">
      ...
      <div style="padding-top: 50px">
          <p style="font-size: 40px">用户登录</p>
      </div>
      <!--input part-->
      <div>
          <form style="font-size: 24px;padding-top: 0px">
              ...
              <div style="align-content: space-between;margin-top: 30px"action="logcheck.jsp" method="post">
              ...
              <div action="signup.jsp" method="post" style="align-content: space-between;margin-top: 10px">
